...
//kategory.OptionMonadErrorInstanceImplicits$instance$1@635b0928
```

```kotlin
monadError<TryHK, Throwable>()
//kategory.TryMonadErrorInstanceImplicits$instance$1@6a3c5810
```

```kotlin
monadError<EitherKindPartial<NukeException>, NukeException>()
//kategory.EitherMonadErrorInstanceImplicits$instance$1@1a1fc4a
```
